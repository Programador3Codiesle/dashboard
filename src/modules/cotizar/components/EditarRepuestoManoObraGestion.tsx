...
import { EDITAR_REPUESTO_MANO_OBRA_SUBMENU_ID } from '@/utils/constants';
...
export function EditarRepuestoManoObraGestion() {
  const { blocked } = useCotizarPageGuard(EDITAR_REPUESTO_MANO_OBRA_SUBMENU_ID);
