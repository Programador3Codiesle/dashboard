...
import { EJECUCION_COTIZADO_VS_FACTURADO_SUBMENU_ID } from '@/utils/constants';
...
export function EjecucionCotizadoVsFacturadoGestion() {
  const { blocked } = useCotizarPageGuard(EJECUCION_COTIZADO_VS_FACTURADO_SUBMENU_ID);
