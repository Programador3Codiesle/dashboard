...
export const btnInfoClass =
  'inline-flex items-center justify-center rounded-lg bg-[var(--color-info)] px-4 py-2 text-sm font-semibold text-white hover:opacity-90 disabled:opacity-50';
