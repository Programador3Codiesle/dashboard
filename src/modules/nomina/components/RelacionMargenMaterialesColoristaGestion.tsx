...
import { RELACION_MARGEN_MATERIALES_COLORISTA_SUBMENU_ID } from '@/utils/constants';
...
export function RelacionMargenMaterialesColoristaGestion() {
  const { blocked } = useNominaPageGuard(RELACION_MARGEN_MATERIALES_COLORISTA_SUBMENU_ID);
