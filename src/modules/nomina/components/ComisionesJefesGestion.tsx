                  ...
                  <tr key={`${row.nit}-${row.sede}`}>
                    ...
                    <td className="px-3 py-1.5 text-center">
                      <button
                        ...
                        className={`${NOMINA_STYLES.detailBtn} disabled:opacity-60`}
                      >
                        <Eye size={14} />
                      </button>
                    </td>
            ...
            <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-3 sm:p-4 md:p-6">
              <div className="app-form-grid-3">
                ...
                <div>
                  ...
                  <input className={NOMINA_STYLES.input} type="number" value={utilidadSede} disabled={isBusyValores} onChange={(e) => setUtilidadSede(e.target.value)} />
                </div>
              </div>
