...
import { NOMINA_DIRECTOR_FLOTAS_SUBMENU_ID } from '@/utils/constants';
...
export function NominaDirectorFlotasGestion() {
  const { blocked } = useNominaPageGuard(NOMINA_DIRECTOR_FLOTAS_SUBMENU_ID);
  ...
  return (
    <div data-testid="nomina-director-flotas-page" className="space-y-6">
      <div>
      ...
      <div className="w-full bg-white rounded-2xl border border-gray-100 p-3 sm:p-4 md:p-6 shadow-lg space-y-4">
        <div className="app-filter-grid">
          <div className="flex flex-col gap-1">
            <label htmlFor="nomina-director-flotas-mes" className="text-xs font-medium text-gray-600">Mes</label>
            <input
              id="nomina-director-flotas-mes"
              data-testid="nomina-director-flotas-mes"
              type="month"
          ...
          <button
            type="button"
            data-testid="nomina-director-flotas-generar"
            onClick={onGenerar}
      ...
      {!generarMutation.isPending && (principalRows.length > 0 || detalleRows.length > 0) && (
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl border border-gray-100 p-4 md:p-5 shadow-sm">
            ...
            <div data-testid="nomina-director-flotas-table" className="app-table-scroll">
