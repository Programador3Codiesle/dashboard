...
import { COMISIONES_LAMINA_PINTURA_SUBMENU_ID } from '@/utils/constants';
import { useNominaPageGuard } from '@/modules/nomina/shared/hooks/useNominaPageGuard';
import { formatCurrency, formatPercent, getApiErrorMessage } from '@/modules/nomina/utils/format-currency';
...
function getPercentBadgeClass(value: number): string {
  ...
  if (safe >= 70) return 'brand-bg-light brand-text brand-border';
      ...
      <div className="w-full bg-white rounded-2xl border border-gray-100 p-3 sm:p-4 md:p-6 shadow-lg space-y-4">
        <div className="app-filter-grid">
          <div className="flex flex-col gap-1">
            <label htmlFor="nomina-lyp-desde" className="text-xs font-medium text-gray-600">Fecha inicial</label>
            <input
              id="nomina-lyp-desde"
              data-testid="nomina-lyp-desde"
              type="date"
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="nomina-lyp-hasta" className="text-xs font-medium text-gray-600">Fecha final</label>
            <input
              id="nomina-lyp-hasta"
              data-testid="nomina-lyp-hasta"
              type="date"
              className={NOMINA_STYLES.input}
              value={hasta}
          ...
          <button
            type="button"
            data-testid="nomina-lyp-generar"
            onClick={onBuscar}
