...
export function PqrNpsGestion() {
  ...
  const guardarGestion = useMutation({
    ...
    onSuccess: async () => {
      ...
      await queryClient.invalidateQueries({ queryKey: ['informes', 'pv', 'pqr-nps'] });
      setGestionItem(null);
    },
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.pqrNps.title}
      description={INFORMES_COPY.pqrNps.description}
