...
export function MpcGestion() {
  ...
  >({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: informesKeys.pv.mpc });
    },
    onError: () => {
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.mpc.title}
      description={INFORMES_COPY.mpc.description}
