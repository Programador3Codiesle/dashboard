...
export function ProductividadTecnicosGestion() {
  ...
  const {
    ...
    queryKey: informesKeys.pv.productividad(JSON.stringify(filtrosAplicados)),
    queryFn: () =>
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.productividadTecnicos.title}
      description={INFORMES_COPY.productividadTecnicos.description}
