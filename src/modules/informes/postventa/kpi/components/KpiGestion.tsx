...
export function KpiGestion() {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: informesKeys.pv.kpi,
    queryFn: () => kpiService.obtenerResumen(),
  });

  const cambiarSeccion = (siguiente: SeccionKpi) => {
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.kpi.title}
      description={INFORMES_COPY.kpi.description}
          ...
          <div className="flex flex-wrap gap-3">
            <label className="inline-flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={() => cambiarSeccion("mantPrev")}
              />
            ...
            <label className="inline-flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={() => cambiarSeccion("cargoCli")}
              />
              <span className="text-sm text-gray-800">
            ...
            <label className="inline-flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={() => cambiarSeccion("tecnicos")}
              />
              <span className="text-sm text-gray-800">
                FACTURACIÓN TOTAL Y OT POR TÉCNICO
              </span>
