...
export function PacNpsInternoDetalladoGestion() {
  ...
  const {
    ...
    queryKey: informesKeys.pv.pacNpsDetallado(consultaFecha ?? ''),
  ...
  const {
    ...
    queryKey: informesKeys.pv.pacNpsDetallado(
      JSON.stringify({ tipo: 'tecnicos', fecha: consultaFecha, bodega: bodegaSel?.id }),
    ),
    queryFn: () =>
  ...
  const {
    ...
    queryKey: informesKeys.pv.pacNpsDetallado(
      JSON.stringify({ tipo: 'encuestas', fecha: consultaFecha, tecnico: modalTecnico }),
    ),
    queryFn: () =>
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.pacNpsDetallado.title}
      description={INFORMES_COPY.pacNpsDetallado.description}
