...
export function TicketPromedioTecnicoGestion() {
  ...
  const {
    ...
    queryKey: informesKeys.pv.ticketPromedio(JSON.stringify(filtros)),
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.ticketPromedio.title}
      description={INFORMES_COPY.ticketPromedio.description}
