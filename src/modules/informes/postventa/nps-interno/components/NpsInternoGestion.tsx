...
export function NpsInternoGestion() {
  ...
  const {
    ...
    queryKey: informesKeys.pv.npsInterno(JSON.stringify(filtroAplicado)),
    queryFn: () =>
      filtroAplicado == null
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.npsInterno.title}
      description={INFORMES_COPY.npsInterno.description}
