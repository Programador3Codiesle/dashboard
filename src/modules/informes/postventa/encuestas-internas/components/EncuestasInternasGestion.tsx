...
export function EncuestasInternasGestion() {
  ...
  const {
    ...
    queryKey: informesKeys.pv.encuestasInternas(JSON.stringify(filtrosAplicados)),
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.encuestasInternas.title}
      description={INFORMES_COPY.encuestasInternas.description}
