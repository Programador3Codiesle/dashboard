...
export function SegundaEntregaGestion() {
  ...
  const {
    ...
    queryKey: informesKeys.pv.segundaEntrega(JSON.stringify(filtrosAplicados)),
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.segundaEntrega.title}
      description={INFORMES_COPY.segundaEntrega.description}
