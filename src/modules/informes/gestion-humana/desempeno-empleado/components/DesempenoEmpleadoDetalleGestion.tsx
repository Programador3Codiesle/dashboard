...
export function DesempenoEmpleadoDetalleGestion() {
  ...
  const detailQuery = useQuery({
    queryKey: informesKeys.gh.desempenoDetalle(String(id)),
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.desempenoEmpleado.title}
      description={INFORMES_COPY.desempenoEmpleado.description}
      backHref="/dashboard/informes/gestion-humana/desempeno-empleado"
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-2xl md:text-2xl sm:text-3xl font-bold brand-text tracking-tight truncate">
