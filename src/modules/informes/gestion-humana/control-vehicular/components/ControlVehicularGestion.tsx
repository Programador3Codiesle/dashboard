...
export function ControlVehicularGestion() {
  ...
  const {
    ...
    queryKey: informesKeys.gh.controlVehicular(JSON.stringify(filtrosAplicados)),
    queryFn: () =>
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.controlVehicular.title}
      description={INFORMES_COPY.controlVehicular.description}
