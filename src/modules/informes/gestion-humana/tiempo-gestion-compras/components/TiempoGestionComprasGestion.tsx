...
export function TiempoGestionComprasGestion() {
  ...
  const {
    ...
    queryKey: informesKeys.gh.tiempoGestionCompras(JSON.stringify(filtrosAplicados)),
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.tiempoGestionCompras.title}
      description={INFORMES_COPY.tiempoGestionCompras.description}
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="app-table-scroll">
          <table className="min-w-[960px] w-full text-xs" id="tabladatos">
