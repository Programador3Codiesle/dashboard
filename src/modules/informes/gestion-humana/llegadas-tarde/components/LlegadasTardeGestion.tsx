...
export function LlegadasTardeGestion() {
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.llegadasTarde.title}
      description={INFORMES_COPY.llegadasTarde.description}
    ...
    <div className="space-y-6">
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-lg border border-gray-100 p-3 sm:p-4 md:p-6 space-y-4">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
          ...
          <button
            ...
            className="inline-flex w-full sm:w-auto justify-center items-center gap-2 px-4 py-2 rounded-xl bg-emerald-700 text-white text-sm font-medium shadow-sm hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed"
          >
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div className="app-table-scroll">
          <table className="min-w-[960px] w-full text-xs" id="tableInfLlegadasTarde">
