...
export function EntradasSalidasGestion() {
  ...
  return (
    <InformesPageFrame
      title={INFORMES_COPY.entradasSalidas.title}
      description={INFORMES_COPY.entradasSalidas.description}
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-3 sm:p-4 md:p-6 space-y-4">
        <div className="app-filter-grid">
          ...
          <InformesEmpleadoFilter
            id="filtro-empleado-entradas-salidas"
            value={empleado}
