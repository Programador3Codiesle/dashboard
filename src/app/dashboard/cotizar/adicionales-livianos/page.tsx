...
export default function AdicionalesLivianosPage() {
  ...
  const { data: listaData, loading: loadingLista } = useListarAdicionalesLivianos({
    adicionalId:
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="brand-card rounded-2xl shadow-lg border border-gray-100 overflow-hidden"
      >
            ...
            {[
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium border-b-2 transition-colors ${
                  activeTab === tab.id
                    ? "border-[var(--color-primary)] text-[var(--color-primary)] bg-gray-50"
              ...
              <div className="flex flex-wrap items-end gap-3">
                <div className="min-w-[220px]">
                  ...
                  <input
                    ...
                    className="block w-full border border-gray-300 rounded-xl p-2.5 text-sm bg-white focus:ring-1 focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] outline-none transition-all"
